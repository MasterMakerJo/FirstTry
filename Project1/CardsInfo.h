...
public:
	...
	int	IsType10LinkThreeSingle(int iCs[]);			//B1001 判断三带单，返回1是，0不是
	int	IsType10LinkThreeDouble(int	iCs[]);			//B1002 判断三带双，返回1是，0不是
	int IsType11FourSingle(int iCs[]);				//B1101 判断四带二单，返回1是，0不是
	int IsType11FourDouble(int iCs[]);				//B1102 判断四带二双，返回1是，0不是
